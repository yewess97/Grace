            ...
            <div class="row">
                <section class="addresses row col-12 gap-4">
                    ...
                    <div class="addresses-add-delete-multiple-buttons row col-12 justify-content-between align-items-center gap-3">
                        ...
                        {{-- Addresses (Delete all selected) & (Add) Buttons --}}
                        @collectionButtons(ADDRESSES_TABLE)
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center align-items-center gap-3">
                                                <button type="button" role="button" title="{{EDIT_ADDRESS_TITLE}}" class="btn edit-btn edit-address-btn" data-mdb-toggle="modal" data-mdb-target="#edit_address_modal" data-route="{{route(EDIT_ADDRESS, $address->id)}}">
                                                    {{ucfirst(EDIT)}}
                                                </button>
                                                <button type="button" role="button" title="{{capitalizeAll(DELETE_ADDRESS)}}" class="btn delete-btn delete-address-btn" data-route="{{route(DELETE_ADDRESS, $address->id)}}" data-name="{{ $address->{USER_MODEL}->{FULL_NAME} }}">
                                                    {{ucfirst(DELETE)}}
                                                </button>
                                            </div>
                                        </td>
