...
<form action="{{route(CREATE_UPDATE_REVIEW, ADD)}}" method="post" role="form" id="add_review_form" class="grace-form review-form flex-wrap py-4 px-0 border-top" data-reviews="{{route(REVIEWS_TABLE, $product->id)}}">
    @csrf
    {{-- Review Form Header --}}
