    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content rounded-3">
            ...
            <article class="modal-body pb-0">
                <form action="{{route(CREATE_UPDATE_USER, UPDATE)}}" method="post" role="form" id="update_user_form" class="grace-form" data-main="{{route(ADMIN_USERS_ROUTE)}}" data-loading_spinner="{{imageSource('loading2.png')}}">
                    @csrf
                    @method('PUT')
