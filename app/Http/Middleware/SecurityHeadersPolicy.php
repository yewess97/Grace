...
class SecurityHeadersPolicy
{
    ...
    final public function handle(Request $request, Closure $next): Closure|JsonResponse|Response|RedirectResponse
    {
        ...
        $style_src   = "style-src 'self' fonts.googleapis.com cdnjs.cloudflare.com unpkg.com www.gstatic.com 'nonce-$nonce' $style_hashes";
        ...
        $img_src     = "img-src 'self' data: flagcdn.com upload.wikimedia.org";
